import{j as e}from"./jsx-runtime-BlAj40OV.js";import{S as g}from"./index-DGLR4QVx.js";import"./index-Cs7sjTYM.js";import"./_commonjsHelpers-BosuxZz1.js";const a=({children:r,noProse:d})=>{const l=d?"":"prose prose-lg md:prose-xl";return e.jsx("main",{className:`ui-main px-6 py-5 md:p-8 ${l}`,children:r})};a.__docgenInfo={description:"",methods:[],displayName:"Main",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},noProse:{required:!1,tsType:{name:"boolean"},description:""}}};const j={title:"Layouts/Main",component:a,tags:["autodocs"]},s={args:{noProse:!1},render:r=>e.jsx(a,{...r,children:e.jsx("p",{children:"Main element"})})},n={args:{...s.args,children:e.jsx(g,{children:e.jsx("p",{children:"Main element"})})},render:r=>e.jsx(a,{...r})};var o,t,i;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: ({
    noProse: false
  } as MainProps),
