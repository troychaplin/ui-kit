import{j as e}from"./jsx-runtime-BlAj40OV.js";import{B as r}from"./index-B1S7lJSW.js";import"./index-Cs7sjTYM.js";import"./_commonjsHelpers-BosuxZz1.js";const s=({children:o,isCenter:i=!1,gap:a=20})=>{const p=i?"justify-center":"justify-start",d={gridGap:a||""};return e.jsx("div",{className:`ui-buttongroup flex ${p}`,style:d,children:o})};s.__docgenInfo={description:"",methods:[],displayName:"ButtonGroup",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},isCenter:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},gap:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"20",computed:!1}}}};const x={title:"Components/Button Group",component:s,tags:["autodocs"]},t={args:{gap:15,isCenter:!1},render:o=>e.jsxs(s,{...o,children:[e.jsx(r,{label:"Button One"}),e.jsx(r,{label:"Button Two",bgColor:"#d3eae2",textColor:"#131313"}),e.jsx(r,{label:"Button Three",textColor:"#0b4a35",isOutline:!0})]})};var n,u,l;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: ({
    gap: 15,
    isCenter: false
  } as ButtonGroupProps),
